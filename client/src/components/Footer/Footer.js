...
const Footer = () => {
  const contributeText = `If you have an interest in contributing to our development efforts, or if you possess innovative ideas and wish to collaborate independently or as part of a team, we extend a warm invitation for you to join and become a valuable contributor.
