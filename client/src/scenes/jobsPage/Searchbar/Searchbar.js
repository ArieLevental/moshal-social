      ...
      jobsData.filter((job) => {
        return (
          (query
            ...
            : true) && (companyFilter ? job.companyId.name.toLowerCase().includes(companyFilter) : true)
        )
      })
    )
  }
  ...
  return (
    <div className='search-bar'>
      ...
      <div className='filter-zone'>
        ...
        <select className='dropdown-menu company' id='company' defaultValue='none' onChange={searchCompanyHandler}>
          <option value='' />
