...
export const users = [
  ...
  },
  {
    ...
    location: 'Room 16',
    bio: 'I<3DZ',
    dateOfBirth: new Date('1998-01-03'),
  ...
  },
  {
    ...
    location: 'Ramat Gan',
    bio: 'Amazing!',
    dateOfBirth: new Date('1998-09-13'),
...
const institutionUrl1 = await getDownloadURL(ref(storage, 'logos/Bar-Ilan.jpg'))
const institutionUrl2 = await getDownloadURL(ref(storage, 'logos/Ben-Gurion.jpg'))
...
const institutionUrl5 = await getDownloadURL(ref(storage, 'logos/Technion.jpg'))
const institutionUrl6 = await getDownloadURL(ref(storage, 'logos/Tel-Aviv.jpg'))
const institutionUrl7 = await getDownloadURL(ref(storage, 'logos/Open.jpg'))
const institutionUrl8 = await getDownloadURL(ref(storage, 'logos/Weizmann.jpg'))
...
export const jobs = [
  ...
  },
  {
    ...
    offerLink: 'https://www.alljobs.co.il/Search/UploadSingle.aspx?JobID=7385803',
  ...
  },
  {
    ...
    offerLink: 'https://www.alljobs.co.il/Search/UploadSingle.aspx?JobID=7429635',
    expReq: '2 years of experience',
    referral: 'George',
    __v: 0
  },
